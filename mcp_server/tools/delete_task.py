"""
Implementation of the delete_task MCP tool for the Todo AI Chatbot
"""
...
async def delete_task_tool(parameters: Dict[str, Any]) -> Dict[str, Any]:
    """
    MCP tool to delete a task according to the specification.
    ...
    Returns:
        Dictionary with success status and task deletion confirmation or error details
    """
    ...
    try:
        with get_session_context() as session:
            # Delete the task using the database service
...
tool_function = delete_task_tool